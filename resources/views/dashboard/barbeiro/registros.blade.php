...
@section('conteudo')
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <h6 class="text-black font-weight-bolder  mb-0">Visualize seus compromissos, {{ session('nome') }}!</h6>
    ...
    <div class="container-fluid py-4">
        ...
        <div class="text-end wow fadeInUp" data-wow-delay="0.1s"
            ...
            <a class="botao-registro" href="{{ route('barbeiro.compromisso') }}">Registros de hoje</a>
        </div>
