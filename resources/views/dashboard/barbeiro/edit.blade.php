...
.radio-inputs .radio input:checked + .name {
  ...
  font-weight: 600;
    ...
    <div data-aos="fade-left" class="card card-5">
        <div class="card-body">
            <form method="POST" action="{{ route('barbeiro.update', ['id' => $barbeiro->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group-desc">
                                    <input class="input--style-5" type="text" value="{{ $barbeiro->nomeFuncionario }}"
                            ...
                            <div class="col-2">
                                <div class="input-group-desc">
                                    <input class="input--style-5" type="text"
                                        value="{{ $barbeiro->sobrenomeFuncionario }}"
                ...
                <div class="form-row m-b-55">
                    ...
                    <div class="col-2" style="width: 100px;display: flex;">
                        <div class="input-group-desc">
                            ...
                            @php
                                $testeDD = '(' . substr($barbeiro->numeroFuncionario, 0, 2) . ')'
                            @endphp
                                value="{{ $testeDD }}"
                        ...
                        <div class="input-group-desc" style="margin-left: 10%;">
                            <input class="input--style-5" style="width:300px;" type="text"
                                value="{{ substr($barbeiro->numeroFuncionario, 2, 5) . '-' . substr($barbeiro->numeroFuncionario, 7) }}"
