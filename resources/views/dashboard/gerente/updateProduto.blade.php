...
@section('conteudo')
    ...
    <div data-aos="fade-left" class="container" style="margin-top: 5%;">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s"
            ...
            <h6 class="section-title bg-white text-center text-primary px-3">Edite as informações do produto no formulário a
                seguir</h6>
    ...
    <div data-aos="fade-left" class="card card-5">
        <div class="card-body">
            <form method="POST" action="{{ route('update.produto', ['id' => $produto->id]) }}"
        ...
        <div class="form-row p-t-20">
            ...
            <div class="p-t-15">
                @if ($produto->statusProduto == 'ativo' || $produto->statusProduto == 'ATIVO')
                    <label class="radio-container m-r-55">ATIVO
                        <input type="radio" checked="checked" name="statusProduto" value="ativo">
                ...
                @else
                    <label class="radio-container m-r-55">ATIVO
                        <input type="radio" name="statusProduto" value="ativo">
                        <span class="checkmark" style="background: #ff6d24 !important"></span>
                    </label>
                    <label class="radio-container">DESATIVO
                        <input type="radio" checked="checked" name="statusProduto" value="inativo">
                        <span class="checkmark" style="background: #ff6d24 !important"></span>
                    </label>
                @endif
            </div>
