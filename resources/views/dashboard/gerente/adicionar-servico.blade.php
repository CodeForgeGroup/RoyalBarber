...
@section('conteudo')
     ...
     */
       ...
       ========================================================================== */
        ...
        .wrapper {
            transition: box-shadow .3s, margin .3s, background-image 1.5s !important;
    ...
    <div data-aos="fade-left" class="container" style="margin-top: 5%;">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s"
            ...
            <a href="{{ route('gerente.servicos') }}">
                <ion-icon style="font-size:20pt;margin-left:100%;" name="arrow-back-outline"></ion-icon>
            </a>
            <h6 class="section-title bg-white text-center text-primary px-3">Adicione um novo serviço ou edite seus serviços
            </h6>
    ...
    <div data-aos="fade-left" class="card card-5">
        <div class="card-body">
            <form method="POST" action="{{ route('adc.servico') }}" enctype="multipart/form-data">
                @csrf

                <div class="wrapper">
                    <button type="button" class="no-image" id="img-result">Upload Image</button>
                    <input type="file" name="fotoServico" id="image_file" style="display:none;">
                </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group-desc">
                                    <input class="input--style-5" type="text" name="nomeServico">
                            ...
                            <div class="col-2">
                                <div class="input-group-desc">
                                    <input class="input--style-5" type="text" name="descricaoServico">
                    ...
                    <div class="value">
                        <div class="row row-space">
                            <div class="col-2" style="width: 200px;display: flex;">
                                <div class="input-group-desc">
                                    <input class="input--style-5" style="width:300px;" type="text" name="valorServico">
                                ...
                                <div class="input-group-desc" style="margin-left: 20%;">
                                    <input class="input--style-5" style="width:300px;" type="text" name="duracaoServico">
                ...
                <div class="form-row p-t-20">
                    ...
                    <div class="p-t-15">
                        <label class="radio-container m-r-55">ATIVO
                            <input type="radio" name="statusServico" value="ATIVO" checked>
                            <span class="checkmark" style="background: #ff6d24 !important"></span>
                        </label>
                        <label class="radio-container">DESATIVO
                            <input type="radio" name="statusServico" value="DESATIVO">
                            <span class="checkmark" style="background: #ff6d24 !important"></span>
                        </label>
                    </div>
