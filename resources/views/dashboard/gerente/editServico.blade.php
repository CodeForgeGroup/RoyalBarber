    ...
    @section('conteudo')
        ...
        <div data-aos="fade-left" class="container" style="margin-top: 5%;">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s"
                ...
                <h6 class="section-title bg-white text-center text-primary px-3">Edite as informações do serviço no formulário a
                    seguir</h6>
        ...
        <div data-aos="fade-left" class="card card-5">
            <div class="card-body">
                <form method="POST" action="{{ route('update.servico', ['id' => $servico->id]) }}"
                    ...
                    <div class="wrapper">
                        ...
                        <input type="file" value="{{ $servico->fotoServico }}" name="fotoServico" id="image_file" style="display:none;">
                    </div>
                            ...
                            <div class="row row-space">
                                <div class="col-2">
                                    <div class="input-group-desc">
                                        <input class="input--style-5" type="text" value="{{ $servico->nomeServico }}" name="nomeServico">
                                ...
                                <div class="col-2">
                                    <div class="input-group-desc">
                                        <input class="input--style-5" type="text" value="{{ $servico->descricaoServico }}" name="descricaoServico">
                                ...
                                <div class="col-2" style="width: 200px;display: flex;">
                                    <div class="input-group-desc">
                                        <input class="input--style-5" style="width:300px;" type="text"
                                            value="{{ $servico->valorServico }}" id="valorServico" name="valorServico">
                                    ...
                                    <div class="input-group-desc" style="margin-left: 20%;">
                                        <input class="input--style-5" style="width:300px;" type="text"
                                            value="{{ $servico->duracaoServico }}" id="duracaoServico" name="duracaoServico">

                                        <label class="label--desc">Duração</label>
            ...
            <div class="form-row p-t-20">
                ...
                <div class="p-t-15">
                    @if ($servico->statusServico == 'ativo' || $servico->statusServico == 'ATIVO')
                        <label class="radio-container m-r-55">ATIVO
                            <input type="radio" checked="checked" name="statusServico" value="ativo">
                            <span class="checkmark" style="background: #ff6d24 !important"></span>
                        </label>
                        <label class="radio-container">DESATIVO
                            <input type="radio" name="statusServico" value="inativo">
                            <span class="checkmark" style="background: #ff6d24 !important"></span>
                        </label>
                    @else
                        <label class="radio-container m-r-55">ATIVO
                            <input type="radio" name="statusServico" value="ativo">
                            <span class="checkmark" style="background: #ff6d24 !important"></span>
                        </label>
                        <label class="radio-container">DESATIVO
                            <input type="radio" checked="checked" name="statusServico" value="inativo">
                            <span class="checkmark" style="background: #ff6d24 !important"></span>
                        </label>
                    @endif
                </div>
