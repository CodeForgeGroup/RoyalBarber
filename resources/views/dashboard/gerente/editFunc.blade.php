...
@section('conteudo')
    ...
    <div data-aos="fade-left" class="card card-5">
        <div class="card-body">
            <form method="POST" action="{{ route('update.funcionario', ['id' => $funcionario->id]) }}"
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group-desc">
                                    <input class="input--style-5" type="text" value="{{ $funcionario->nomeFuncionario }}"
                            ...
                            <div class="col-2">
                                <div class="input-group-desc">
                                    <input class="input--style-5" type="text"
                                        value="{{ $funcionario->sobrenomeFuncionario }}"id="sobrenomeFuncionario"
                ...
                <div class="form-row m-b-55">
                    <div class="name">Pendências</div>
                    <div class="value">
                        <div class="row row-space">
                            <div class="col-2" style="width: 200px;display: flex;">
                                <div class="input-group-desc">
                                    <input class="input--style-5" style="width:300px;" type="text"
                                        value="{{ $funcionario->especialidadeFuncionario }}" id="especialidadeFuncionario"
                    ...
                    <div class="value">
                        <div class="row row-space">
                            <div class="col-2" style="width: 200px;display: flex;">
                                <div class="input-group-desc">
                                    <input class="input--style-5" style="width:300px;" type="text"
                                        value="{{ $funcionario->inicioExpedienteFuncionario }}"
                                ...
                                <div class="input-group-desc" style="margin-left: 7%;">
                                    <input class="input--style-5" style="width:300px;" type="text"
                                        value="{{ $funcionario->fimExpedienteFuncionario }}" id="fimExpedienteFuncionario"
                    ...
                    <div class="col-2" style="width: 250px;display: flex;">
                        <div class="input-group-desc">
                            <input class="input--style-5" style="width:640px;" type="text"
                                value="{{ $funcionario->emailFuncionario }}" id="emailFuncionario"
                    ...
                    <div class="col-2" style="width: 100px;display: flex;">
                        <div class="input-group-desc">
                            <input class="input--style-5" style="width:100px;" type="text"
                                @php
$testeDD = '(' . substr($funcionario->numeroFuncionario, 0, 2) . ')' @endphp
                        ...
                        <div class="input-group-desc" style="margin-left: 10%;">
                            <input class="input--style-5" style="width:300px;" type="text"
                                value="{{ substr($funcionario->numeroFuncionario, 2, 5) . '-' . substr($funcionario->numeroFuncionario, 7) }}"id="numeroFuncionario"
                                name="telefoneFuncionario" maxlength="100">
                    ...
                    <div class="col-2" style="width: 300px;display: flex;">
                        <div class="input-group-desc" style="margin-left: 590px;">
                            <textarea style="width:500px;height:100px;border:0px;resize:none;" class="input--style-5" name="descricaoFuncionario"
                                id="descricaoFuncionario" cols="30" rows="10">{{ $funcionario->descricaoFuncionario }}</textarea>
                    ...
                    <div class="col-2" style="width: 100px;display: flex;">
                        <div class="input-group-desc">
                            <input class="input--style-5" style="width:150px;" type="date" name="dataNascFuncionario"
                                value='{{ $funcionario->dataNascFuncionario }}'>
                        ...
                        <div class="input-group">
                            <div class="rs-select2 js-select-simple select--no-search" style="margin-top: 1%;">
                                <div class="radio-inputs">
                                    @if ($funcionario->cargoFuncionario == 'gerente')
                                        <label class="radio">
                ...
                <div class="form-row p-t-20">
                    ...
                    <div class="p-t-15">
                        @if ($funcionario->statusFuncionario == 'ativo' || $funcionario->statusFuncionario == 'ATIVO')
                            ...
                            <label class="radio-container">DESATIVO
                                <input type="radio" name="statusFuncionario" value="inativo">
                                <span class="checkmark" style="background: #ff6d24 !important"></span>
                            </label>
                        @else
                            <label class="radio-container m-r-55">ATIVO
                                <input type="radio" name="statusFuncionario" value="ativo">
                                <span class="checkmark" style="background: #ff6d24 !important"></span>
                            </label>
                            <label class="radio-container">DESATIVO
                                <input type="radio" checked="checked" name="statusFuncionario" value="inativo">
                                <span class="checkmark" style="background: #ff6d24 !important"></span>
                            </label>
                        @endif
                    </div>
