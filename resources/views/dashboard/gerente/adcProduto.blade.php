...
@section('conteudo')
    ...
    <div data-aos="fade-left" class="container" style="margin-top: 5%;">
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s"
            ...
            <h6 class="section-title bg-white text-center text-primary px-3">Adicione um novo produto ao seu estoque</h6>
    ...
    <div data-aos="fade-left" class="card card-5">
        <div class="card-body">
            <form method="POST" action="{{ route('adicionar.produto') }}" enctype="multipart/form-data">
                @csrf

                <div class="wrapper">
                    <button type="button" class="no-image" id="img-result">Upload Image</button>
                    <input type="file" name="fotoProduto" id="image_file" style="display:none;">
                </div>
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group-desc">
                                    <input class="input--style-5" type="text" name="nomeProduto">
                            ...
                            <div class="col-2">
                                <div class="input-group-desc">
                                    <input class="input--style-5" type="text" name="descricaoProduto">
                    ...
                    <div class="value">
                        <div class="row row-space">
                            <div class="col-2" style="width: 200px;display: flex;">
                                <div class="input-group-desc">
                                    <input class="input--style-5" style="width:300px;" type="text" name="valorProduto">
                                ...
                                <div class="input-group-desc" style="margin-left: 20%;">
                                    <input class="input--style-5" style="width:300px;" type="text" name="estoqueProduto">
                ...
                <div class="form-row p-t-20">
                    ...
                    <div class="p-t-15">
                        <label class="radio-container m-r-55">ATIVO
                            <input type="radio" name="statusProduto" value="ativo" checked>
                            <span class="checkmark" style="background: #ff6d24 !important"></span>
                        </label>
                        <label class="radio-container">DESATIVO
                            <input type="radio" name="statusProduto" value="inativo">
                            <span class="checkmark" style="background: #ff6d24 !important"></span>
                        </label>
                    </div>
